<template>
  <view class="page">
   ...
   <!-- 销售规格 -->
    <goods-size :pikerValue="pikerValue" :valueWeight="valueWeight" v-if="currentIndex === 1" @changeWeight="doWeight" @changePiker="doPiker"></goods-size>
  <!-- 计数单位 -->
   ...
   <!-- 销售单价 -->
    ...
    <!-- 货品分类 -->
    <goods-classify :valueKind="valueKind" @changeKind="doKind"></goods-classify>
    <!-- 保存按钮 -->
...
<script>
  export default {
    ...
    methods: {
      ...
      saveAdd(){
         console.log('货品分类的名字', this.valueKind, '货品名字', this.valueName, '包装类型', this.packagingType, '货品的单价', this.valuePrice, '销售规格的input',
               ...
               this.productList=[...this.productList,{
                 ...
                 productId:'00' + String(this.productList.length +1),
